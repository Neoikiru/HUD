...
namespace Core {
    ...
    static void CustomLogCallback(void* userdata, int category, SDL_LogPriority priority, const char* message) {
        ...
        switch (priority) {
            case SDL_LOG_PRIORITY_VERBOSE:  levelStr = "TRACE"; colorCode = "\033[37m"; break; // Gray
            case SDL_LOG_PRIORITY_DEBUG:    levelStr = "DEBUG"; colorCode = "\033[36m"; break; // Cyan
            case SDL_LOG_PRIORITY_INFO:     levelStr = "INFO "; colorCode = "\033[32m"; break; // Green
            case SDL_LOG_PRIORITY_WARN:     levelStr = "WARN "; colorCode = "\033[33m"; break; // Yellow
            case SDL_LOG_PRIORITY_ERROR:    levelStr = "ERROR"; colorCode = "\033[31m"; break; // Red
            case SDL_LOG_PRIORITY_CRITICAL: levelStr = "CRIT "; colorCode = "\033[41m"; break; // Red Background
            default: break;
        }
        ...
        printf("\033[90m[%02d:%02d:%02d.%03d]\033[0m [\033[35m%s Thread\033[0m] %s[%s]\033[0m %s\n",
            ...
            thrdName, colorCode, levelStr, message);
    }
